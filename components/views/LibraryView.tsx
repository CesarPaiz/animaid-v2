...
import { LibraryIcon, UserCircleIcon } from '../icons';
...
const STATUS_TABS_ORDERED: { key: MediaListStatus; label: string }[] = [
    ...
    { key: MediaListStatus.DROPPED, label: "Dropeado" },
...
const LibraryView: React.FC<{ onMediaSelect: (media: Media) => void }> = ({ onMediaSelect }) => {
    ...
    const { user, getFullLibraryList, authStatus } = useAuth();
    ...
    }, [user, authStatus.isLoading, getFullLibraryList]);
        ...
        return (
            <div className="pt-8 text-center px-4">
                ...
                <div className="mt-16">
                    ...
                    <p className="text-gray-400 mt-4 text-lg">Inicia sesión para ver tu lista.</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="pt-8">
            ...
            <div className="px-4 md:px-6 mb-4 sticky top-0 bg-gray-950/80 backdrop-blur-lg py-2 z-10">
